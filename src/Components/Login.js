 ...
 const txStyle={
  ...
  return (
   ...
   variant='h5' sx={{color:'brown'}} padding={2.5} textAlign='center' >BookRack</Typography>
                ...
                <TextField helperText={enteredEmail==='' && enteredEmailTouched ?'E-mail cannot be empty':enteredEmailIsInValid?'Please enter a valid Email':''}value={enteredEmail} onChange={emailHandler} onBlur={emailBlurHandler}error={enteredEmailIsInValid}  sx={txStyle } label='E-mail' size='small' margin='normal' variant='outlined' placeholder='E-mail'></TextField>
